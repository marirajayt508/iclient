  ...
  return (
    <Box >
      ...
      marginLeft: dopen ? '170px' : '0', // Adjust the width based on the drawer state
       ...
       {signin && signin.role=='user' && <Box> <Userbody tdatas={tdatas} status={status} fields={fields} uploads={uploads} udraw={userMenu}  menu={menu}  datas={signin} username={signin.username} setpage={(v)=>setPage(v)}/></Box>}
